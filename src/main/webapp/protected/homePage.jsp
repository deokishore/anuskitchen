                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 combo" style="padding:0px;">
                                    ...
                                    <div class="col-md-4 col-xs-12 col-sm-6">
                                        <div class="panel panel-default enjoy-css hvr-float-shadow">
                                            <div class="panel-heading">
                                                <img src="/resources/images/gh/16xNxnon-veg.png.pagespeed.ic.FBZoimdQ8M.png" style="width:16px; margin-top:-8px"
                                                class="img-responsive"> <span class="food-name" style="font-size: 18px;">Veg Combo - 140</span>
                                                <br>
                                                <span class="price  pull-left" style="margin-top: 15px;"><!-- <b>PRICE :</b> <span class="orange">Rs
                                                .<strike>/-</strike></span> --></span>
                                                <br>
                                                <span class="offer-price pull-right" style="  margin-top: -10px;"><span class="offtext"><!-- OFFER --> </span>PRICE Rs.
                                                 149/-</span>
                                            </div>

                                            <div class="panel-body">
                                                <img src="/resources/images/gh/uploads/xNV150.jpg.pagespeed.ic.9ZcY10TY1d.jpg" class="img-responsive" />
                                                <h3 style="padding-top: 10px;  padding-bottom: 10px; font-size: 12pt;" data-toggle="tooltip" data-placement="top"
                                                 title="Paneer Alu Mattar + Paratha + Kheer + Salad">Paneer Alu Mattar + Paratha + Kh<span>..</span></h3>
                                                <p>Paneer Alu Mattar <span data-toggle="modal" data-target="#readmore1" style="color: rgb(19, 148, 240); cursor:pointer;">
                                                 Read more..</span></p>
                                                <p><strong style="font-weight: bold;">Cuisine :</strong> <span style="color: rgb(45, 142, 144);  font-weight: bold;">
                                                North Indian</span></p>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-xs-12 col-sm-6">
                                        <div class="panel panel-default enjoy-css hvr-float-shadow">
                                            <div class="panel-heading">
                                                <img src="/resources/images/gh/16xNxveg.png.pagespeed.ic.eNpO-hI4o5.png" style="width:16px; margin-top:-8px"
                                                class="img-responsive"> <span class="food-name" style="font-size: 18px;">Veg Combo - 140</span>
                                                <br>
                                                <span class="price  pull-left" style="margin-top: 15px;"><!-- <b>PRICE :</b> <span class="orange">Rs
                                                .<strike>/-</strike></span> --></span>
                                            ...
                                            <div class="panel-body">
                                                <img src="/resources/images/gh/uploads/xV144.gif.pagespeed.ic.e1Y4oHxRPo.jpg" class="img-responsive" />
                                                <h3 style="padding-top: 10px;  padding-bottom: 10px; font-size: 12pt;" data-toggle="tooltip" data-placement="top"
                                                 title="Paneer Alu Mattar + Paratha + Kheer + Salad">Paneer Alu Mattar + Paratha + Kh<span>..</span></h3>
                                                <p>Paneer Alu Mattar <span data-toggle="modal" data-target="#readmore1" style="color: rgb(19, 148, 240); cursor:pointer;">
                                                 Read more..</span></p>
                                    ...
                                    <div class="col-md-4 col-xs-12 col-sm-6">
                                        <div class="panel panel-default enjoy-css hvr-float-shadow">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <img src="/resources/images/gh/uploads/xV140.jpg.pagespeed.ic.-__3E2S3-8.jpg" class="img-responsive" />
                                                <!--     <img src="http://www.gohomely.com//resources/images/gh/i1.jpg"  class="img-responsive"> -->
                                                <h3 style="padding-top: 10px;  padding-bottom: 10px; font-size: 12pt;" data-toggle="tooltip" data-placement="top"
                                                 title="Paneer Alu Mattar + Paratha + Kheer + Salad">Paneer Alu Mattar + Paratha + Kh<span>..</span></h3>
                                                <p>Paneer Alu Mattar <span data-toggle="modal" data-target="#readmore1" style="color: rgb(19, 148, 240); cursor:pointer;
                                                "> Read more..</span>
