...
/* Work Page Layout using packery*/
$(window).load(function() {
	$('.homeSolutions').packery({
		gutter: 0
	});
});

/* Work page direction aware hover effect */
$(' #direction0 > li ').each( function() { $(this).hoverdir();} );

/* Make Section height 100%*/
vpw = $(window).width();
vph = $(window).height();
$('.full-page').css('min-height',vph);

/* Initialize home page squence slider */
var options = {
	nextButton: ".next",
	prevButton: ".prev",
	prependNextButton:"body",
	prependPrevButton:"body",
	autoPlay: true,
	autoPlayDelay: 3000,
	pauseIcon: false,
...
$(function(){
	$(window).scroll(function() {
		...
		$.data(this, 'scrollTimer', setTimeout(function() {
			var eTop = $('.testimonialSlider').offset().top; //get the offset top of the element
...
$('#testimonialContainer ul.testimonialSlider').bxSlider();

/*
$('.bx-prev, .bx-next').on('click',function(){
	if ($("#testimonialContainer ul.testimonialSlider li").hasClass("active-slide")) {
		$('.fill').addClass('active');
	}
	else{
...
$('#testimonialContainer ul.testimonialSlider').bxSlider({
	...
	onSliderLoad: function(currentIndex) {     
	  $('#testimonialContainer').find('.bx-viewport').find('ul').children().eq(currentIndex + 1).addClass('active-slide');
	},
	onSlideBefore: function($slideElement){
	  $('#testimonialContainer').find('.bx-viewport').find('ul').children().removeClass('active-slide');
